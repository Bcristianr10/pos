    ...
    <div class="card-body">
        <form action="{{ route('settings.store') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="tax_percentage" class="form-control @error('tax_percentage') is-invalid @enderror" id="tax_percentage" placeholder="{{ __('settings.tax_percentage') }}" value="{{ old('tax_percentage', config('settings.tax_percentage')) }}">
